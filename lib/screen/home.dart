...
class _HomeState extends State<Home> {
  List<HomeItemCard> bucket1 = [
    ...
    HomeItemCard('assets/Noodles.avif', "50% off", "Faasos - Wraps and rolls ", "4.5", "20", "25","Chinese King"),
    HomeItemCard('assets/Cake.avif', "50% off", "Cake", "4.5", "20", "25","Faasos - Wraps and rolls"),
    HomeItemCard('assets/Cake.avif', "50% off", "Cake", "4.5", "20", "25","Faasos - Wraps and rolls"),
    HomeItemCard('assets/Cake.avif', "50% off", "Cake", "4.5", "20", "25","Monginis"),
    HomeItemCard('assets/Cake.avif', "50% off", "Cake", "4.5", "20", "25","Faasos - Wraps and rolls"),
    HomeItemCard('assets/Cake.avif', "50% off", "Cake", "4.5", "20", "25","Faasos - Wraps and rolls"),
    HomeItemCard('assets/Cake.avif', "50% off", "Cake", "4.5", "20", "25","Faasos - Wraps and rolls"),
  ];
